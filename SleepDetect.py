...
print(left_eye_start, left_eye_end)
print(right_eye_start, right_eye_end)
...
while True:
	...
	faces = face_detect.detectMultiScale(frame, scaleFactor=1.1,		minNeighbors=5, minSize=(100, 100),		flags=cv2.CASCADE_SCALE_IMAGE)
	...
	for (x, y, w, h) in faces:
		...
		cv2.rectangle(gray, (int(x), int(y)), (int(x+w), int(y+h)), (255, 0, 0), 3)
